package com.lookballs.imageloader.glide.util.blur;
...
public class FastBlur {
    ...
    public static void blur(Context context, Bitmap bitmap, View view) {
        ...
        float scaleFactor = 8;
        //放大到整个view的大小
        bitmap = DrawableUtil.getReSizeBitmap(bitmap, view.getMeasuredWidth(), view.getMeasuredHeight());
    ...
    public static Bitmap blurBitmap(Bitmap bitmap, int width, int height) {
        ...
        float scaleFactor = 8;
        //放大到整个view的大小
        bitmap = DrawableUtil.getReSizeBitmap(bitmap, width, height);
